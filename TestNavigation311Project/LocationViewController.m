        ...
        if (![CLLocationManager locationServicesEnabled] || [CLLocationManager authorizationStatus] == kCLAuthorizationStatusDenied)
        {
            ...
            [geocoder geocodeAddressString:defaultLocation completionHandler:^(NSArray *placemarks, NSError *error) {
                ...
                if (placemark != nil)
                {
                    ...
                    if (annotation != nil)
                    {
                        if ([self.subCategoryName isEqualToString:@""])
                            annotation.title = @"Problem Spot";
                        else
                            annotation.title = self.subCategoryName;
                        
                        annotation.subtitle = [NSString stringWithFormat:@"%@ %@, %@", [placemark subThoroughfare], [placemark thoroughfare], [placemark locality]];
            ...
            [geocoder reverseGeocodeLocation:location completionHandler:^(NSArray *placemarks, NSError *error)
             {
                 ...
                 if (placemark != nil)
                 address = [NSString stringWithFormat:@"%@ %@, %@", [placemark subThoroughfare], [placemark thoroughfare], [placemark locality]];
